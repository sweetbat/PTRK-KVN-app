...
fun AndroidMainScreen(
    ...
    var needsLanguagePicker by remember { mutableStateOf(false) }
    val appLanguage by org.olcbox.app.i18n.AppLocale.language.collectAsState()
    ...
    if (needsLanguagePicker) {
        org.olcbox.app.ui.components.LanguagePickerDialog(
            onLanguageChosen = { language ->
                scope.launch {
                    org.olcbox.app.i18n.AppLanguageStore.save(context, language)
                    needsLanguagePicker = false
                }
            }
        )
    }
